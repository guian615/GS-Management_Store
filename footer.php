        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
                    ...
                    <p class="mb-4">Fruit Titos Info</p>
                    <ul class="f-address">
                        <li>
                            <div class="row">
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <p><a href="#">fuittitos.netlify.app</a></p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <h6 class="font-weight-bold mb-0">Phone Number:</h6>
                                    <p><a href="#">+639 434 672 2928</a></p>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="f-address">
                        <li>
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <p class="mb-0"><a href="#">@fruittitos </a>Guian Amancio</p>
                        ...
                        <li>
                            <div class="row">
                                <div class="col-1"><i class="fab fa-twitter"></i></div>
                                <div class="col-10">
                                    <p class="mb-0"><a href="#">@fruittitos </a> Justine Ambrad </p>
                                    <label>10 Mins Ago</label>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="row">
                                <div class="col-1"><i class="fab fa-twitter"></i></div>
                                <div class="col-10">
                                    <p class="mb-0"><a href="#">@fruittitos </a> Patrick Glinogo</p>
                                    <label>10 Mins Ago</label>
                                </div>
                            </div>
                        </li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
                    ...
                    <ul class="recent-post">
                        <li>
                            <label class="mr-3">20 <br><span>APR</span></label>
                            <span>Rendomised words which dont look eveable.</span>
                        </li>
                        <li>
                            <label class="mr-3">17 <br><span>APR</span></label>
                            <span>Rendomised words which dont look eveable.</span>
                        </li>
                        <li>
                            <label class="mr-3">30 <br><span>MAR</span></label>
                            <span>Rendomised words which dont look eveable.</span>
                        </li>
                    </ul>
                </div>
